...
- Relationship import IDs:
  - Standard associations: `<parent_id>:<child_id>` (for example `12:34`)
  - Survey spec relationships: `<parent_id>` (for example `12`)
...
- Standard relationships:
  ...
  - State/import ID: `<parent_id>:<child_id>`
- Survey spec relationships (`.../survey_spec/`) are special:
  - Inputs: `parent_id`, `spec` (JSON string)
  - State/import ID: `<parent_id>`
