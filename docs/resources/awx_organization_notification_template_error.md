...
Manages `organization_notification_template_error` relationships between `organizations` and `notification_templates` objects.
...
```bash
terraform import awx_organization_notification_template_error.example 12:34
```
