...
Manages `job_template_notification_template_started` relationships between `job_templates`
...
```bash
terraform import awx_job_template_notification_template_started.example \
  12:34
```
