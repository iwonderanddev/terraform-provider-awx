...
Manages `system_job_template_notification_template_success` relationships between `system_job_templates`
...
```bash
terraform import awx_system_job_template_notification_template_success.example \
  12:34
```
