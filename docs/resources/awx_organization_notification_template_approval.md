...
Manages `organization_notification_template_approval` relationships between `organizations`
...
```bash
terraform import awx_organization_notification_template_approval.example \
  12:34
```
