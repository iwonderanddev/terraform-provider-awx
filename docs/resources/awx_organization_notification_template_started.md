...
Manages `organization_notification_template_started` relationships between `organizations`
...
```bash
terraform import awx_organization_notification_template_started.example \
  12:34
```
