...
Manages `inventory_source_notification_template_success` relationships between `inventory_sources`
...
```bash
terraform import awx_inventory_source_notification_template_success.example \
  12:34
```
