...
Manages `organization_notification_template_association` relationships between `organizations`
...
```bash
terraform import awx_organization_notification_template_association.example \
  12:34
```
