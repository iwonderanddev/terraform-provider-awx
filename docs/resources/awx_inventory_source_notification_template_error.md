...
Manages `inventory_source_notification_template_error` relationships between `inventory_sources` and `notification_templates` objects.
...
```bash
terraform import awx_inventory_source_notification_template_error.example 12:34
```
