...
Manages `job_template_notification_template_error` relationships between `job_templates`
...
```bash
terraform import awx_job_template_notification_template_error.example \
  12:34
```
