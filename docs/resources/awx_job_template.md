...
- `ask_credential_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_diff_mode_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_execution_environment_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_forks_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_instance_groups_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_inventory_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_job_slice_count_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_job_type_on_launch` (Optional) Managed field from AWX OpenAPI schema.
...
- `ask_timeout_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_variables_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `ask_verbosity_on_launch` (Optional) Managed field from AWX OpenAPI schema.
- `become_enabled` (Optional) Managed field from AWX OpenAPI schema.
- `description` (Optional) Managed field from AWX OpenAPI schema.
- `diff_mode` (Optional) If enabled, textual changes made to any templated files on the host are shown in the standard output
...
- `force_handlers` (Optional) Managed field from AWX OpenAPI schema.
...
- `job_slice_count` (Optional) The number of jobs to slice into at runtime. Will cause the Job Template to launch a workflow if value is greater than 1.
...
- `prevent_instance_group_fallback` (Optional) If enabled, the job template will prevent adding any inventory or organization instance groups to the list of preferred instances groups to run on.If this setting is enabled and you provided an empty list, the global instance groups will be applied.
...
- `use_fact_cache` (Optional) If enabled, the service will act as an Ansible Fact Cache Plugin; persisting facts at the end of a playbook run to the database and caching facts for use by Ansible.
