...
- `default_environment_id` (Optional) The default execution environment for jobs run using this project.
...
- `signature_validation_credential_id` (Optional) An optional credential used for validating files in the project against unexpected changes.
