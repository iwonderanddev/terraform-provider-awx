...
Manages `job_template_instance_group_association` relationships between `job_templates`
...
```bash
terraform import awx_job_template_instance_group_association.example \
  12:34
```
