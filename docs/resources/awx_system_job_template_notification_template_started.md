...
Manages `system_job_template_notification_template_started` relationships between `system_job_templates`
...
```bash
terraform import awx_system_job_template_notification_template_started.example \
  12:34
```
