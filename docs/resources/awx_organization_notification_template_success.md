...
Manages `organization_notification_template_success` relationships between `organizations`
...
```bash
terraform import awx_organization_notification_template_success.example \
  12:34
```
