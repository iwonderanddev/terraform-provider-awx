...
Manages AWX associations between `inventories` and `instance_groups` objects.
...
```bash
terraform import awx_inventory_instance_group_association.example <primary_id>:<related_id>
```
