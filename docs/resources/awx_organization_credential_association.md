...
Manages AWX associations between `organizations` and `credentials` objects.
...
```bash
terraform import awx_organization_credential_association.example <primary_id>:<related_id>
```
