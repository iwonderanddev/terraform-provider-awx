...
Manages `workflow_job_template_node_instance_group_association` relationships between `workflow_job_template_nodes`
...
```bash
terraform import awx_workflow_job_template_node_instance_group_association.example \
  12:34
```
