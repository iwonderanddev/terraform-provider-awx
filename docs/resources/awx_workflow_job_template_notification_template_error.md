...
Manages `workflow_job_template_notification_template_error` relationships between `workflow_job_templates` and `notification_templates` objects.
...
```bash
terraform import awx_workflow_job_template_notification_template_error.example 12:34
```
