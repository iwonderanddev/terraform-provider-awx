...
Manages AWX associations between `workflow_job_template_nodes` and `credentials` objects.
...
```bash
terraform import awx_workflow_job_template_node_credential_association.example <primary_id>:<related_id>
```
