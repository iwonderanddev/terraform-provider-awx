...
Manages `workflow_job_template_notification_template_approval` relationships between `workflow_job_templates`
...
```bash
terraform import awx_workflow_job_template_notification_template_approval.example \
  12:34
```
