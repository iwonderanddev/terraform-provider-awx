...
Manages AWX associations between `job_templates` and `schedules` objects.
...
```bash
terraform import awx_job_template_schedule_association.example <primary_id>:<related_id>
```
