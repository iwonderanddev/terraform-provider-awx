...
Manages AWX associations between `organizations` and `instance_groups` objects.
...
```bash
terraform import awx_organization_instance_group_association.example <primary_id>:<related_id>
```
