...
Manages `workflow_job_template_label_association` relationships between `workflow_job_templates`
and `labels` objects.
...
```bash
terraform import awx_workflow_job_template_label_association.example \
  12:34
```
