...
Manages AWX associations between `workflow_job_templates` and `labels` objects.
...
```bash
terraform import awx_workflow_job_template_label_association.example <primary_id>:<related_id>
```
