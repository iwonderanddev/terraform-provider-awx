...
Manages `workflow_job_template_schedule_association` relationships between `workflow_job_templates`
...
```bash
terraform import awx_workflow_job_template_schedule_association.example \
  12:34
```
