...
Manages `project_notification_template_started` relationships between `projects` and `notification_templates` objects.
...
```bash
terraform import awx_project_notification_template_started.example 12:34
```
