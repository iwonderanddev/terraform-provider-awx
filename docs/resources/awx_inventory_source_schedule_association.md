...
Manages `inventory_source_schedule_association` relationships between `inventory_sources`
...
```bash
terraform import awx_inventory_source_schedule_association.example \
  12:34
```
