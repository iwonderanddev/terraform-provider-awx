...
- `automation_analytics_last_entries` (String, Read-Only) Value for `automation_analytics_last_entries`.
- `automation_analytics_last_gather` (String, Read-Only) Value for `automation_analytics_last_gather`.
...
- `cleanup_host_metrics_last_ts` (String, Read-Only) Value for `cleanup_host_metrics_last_ts`.
...
- `default_control_plane_queue_name` (String, Read-Only) Value for `default_control_plane_queue_name`.
...
- `default_execution_queue_name` (String, Read-Only) Value for `default_execution_queue_name`.
...
- `host_metric_summary_task_last_ts` (String, Read-Only) Value for `host_metric_summary_task_last_ts`.
...
- `install_uuid` (String, Read-Only) Value for `install_uuid`.
...
- `subscription_usage_model` (String, Read-Only) * `` - No subscription. Deletion of host_metrics will not be considered for purposes of managed host counting
