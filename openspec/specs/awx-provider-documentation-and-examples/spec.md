...
Define quality and structure requirements for generated Terraform provider
documentation and examples so they remain accurate, usable, and aligned with
official AWX behavior documentation.
