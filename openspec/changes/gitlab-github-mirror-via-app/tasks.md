...
- [ ] 3.2 After merge to the default branch on GitLab, confirm the pipeline succeeds and the GitHub mirror receives expected refs; confirm logs do not contain the installation token
